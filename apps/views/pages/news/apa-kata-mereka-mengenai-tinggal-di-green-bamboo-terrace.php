...
<div style="color: #000;background-color:#fff;text-align:left;padding: 120px 5% 20px 5%;text-align: justify;">
    <div style="margin: 20px 0;">
        <ul class="breadcrumbdesign">
            ...
            <li><a href="<?php echo base_url ('news/apa-kata-mereka-mengenai-tinggal-di-green-bamboo-terrace'); ?>">
    ...
    <div class="row">
        ...
        <div class="col-md-9" id="newsContent">
            <div class="pl-3">
                ...
                <h3 class="news-title">Apa Kata Mereka Mengenai Tinggal di Green Bamboo Terrace</h3>
                <p class="news-date text-italic text-muted">Jumat, 3 Juli 2020</p>
            </div>
