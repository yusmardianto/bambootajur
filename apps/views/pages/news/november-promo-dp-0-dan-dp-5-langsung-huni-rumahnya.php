...
<div style="color: #000;background-color:#fff;text-align:left;padding: 120px 5% 20px 5%;text-align: justify;">
    <div style="margin: 20px 0;">
        <ul class="breadcrumbdesign">
            ...
            <li><a href="<?php echo base_url ('berita-dan-promo/november-promo-dp-0-dan-dp-5-langsung-huni-rumahnya'); ?>">November Promo - DP 0% dan DP 5% Langsung Huni Rumahnya!</a></li>
        </ul>
    </div>
    <div class="row">
        <!-- NEWS SIDE BAR -->
