...
<nav id="navbar" class="">
  <div class="nav-wrapper">
    ...
    <ul id="menu">
      ...
      <li><a href="<?= site_url(['the-homes'])?>" class="dropdown-toggle" data-toggle="dropdown">The Homes&nbsp;<span><i
...
<!-- <div style="color: #000;background-color:#fff;text-align:center;text-align: justify;" class="position-relative"> -->
<!-- <img src="<?= base_url();?>assets/images/background/bambootajur-facility-club-house-20190226.jpg" class="w-100"
    alt=""> -->
...
<div class="bgimg-4">
  <div class="card-content-3">
    <div class="row">
      <div class="col-md-4">
        <div class="jumbotron__category">
          <h6 class="head-title ml-4 mt-4">THE FACILITIES</h6>
        </div>
      </div>
    ...
    <div class="jumbotron__category9">
      <h3 class="head-title ml-4">Fasilitas publik dan penghuni</h3>
    </div>
    <!-- <div class="row">
      <div class="col-md-3">
      </div> -->
    <div class="visualtext pb-4 ">
      <p class="text-justify">Semua penghuni Green Bamboo Terrace Bogor dapat menggunakan fasilitas terbaik yang sudah
        kami sediakan, tidak hanya fasilitas publik tapi kami juga memperhatikan penuh setiap fasilitas pribadi setiap
        penghuni.</p>
    </div>
    <!-- </div> -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item">
        <img class="d-block w-100"
          src="<?= base_url();?>assets/images/background/bambootajur-facility-club-house-20190226.jpg"
          data-color="lightblue" alt="First Image">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100"
          src="<?= base_url();?>assets/images/background/bambootajur-facility-club-house-2-20190226.jpg"
          data-color="firebrick" alt="Second Image">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100"
          src="<?= base_url();?>assets/images/background/bambootajur-facility-club-house-3-20190226.jpg"
          data-color="firebrick" alt="Second Image">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="<?= base_url();?>assets/images/background/park.jpg" data-color="violet"
          alt="Third Image">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100"
          src="<?= base_url();?>assets/images/background/bambootajur-facility-mushola-20190226.jpg" data-color="violet"
          alt="Third Image">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100"
          src="<?= base_url();?>assets/images/background/bambootajur-facility-mushola-2-20190226.jpg"
...
<div class="minidesc pr-5 pl-5">
  <div class="row">
    <div class="col-md-3">
      <h3 class="font-weight-bold pt-5 my-4">FASILITAS PUBLIK</h3>
    </div>
    ...
    <div class="col-md-6 col-sm-12 p-3">
      <div class="d-flex flex-row">
        ...
        <div>
          ...
          <p class="text-justify pt-2">Di dalam Perumahan tersedia juga taman dan area bermain anak, sehingga membuat
            hunian
            menjadi lebih asri dan anak-anak dapat menikmati fasilitas bermain anak di Green Bamboo Terrace Bogor.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 col-sm-12 p-3">
      <div class="d-flex flex-row">
        ...
        <div>
          ...
          <p class="text-justify pt-2">Tak lupa kami menyediakan Mushola untuk memudahkan penghuni kami dalam beribadah.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 col-sm-12 p-3">
      <div class="d-flex flex-row">
        ...
        <div>
          ...
          <p class="text-justify pt-2">Dengan adanya ClubHouse yang berada di dalam perumahan Green Bamboo Terrace Bogor
            membuat Anda dan keluarga dapat menikmati hidup yang lebih nyaman. Fasilitas yang tersedia di ClubHouse
            adalah
            Kolam renang anak, ruang membaca, dan ruang serbaguna yang dapat dimanfaatkan sebagai ruang pertemuan warga
            atau
    ...
    <div class="col-md-6 col-sm-12 p-3">
      <div class="d-flex flex-row">
        ...
        <div>
          ...
          <p class="text-justify pt-2">Keamanan menjadi perhatian kami, sehingga dapat menjamin rasa nyaman dan aman
            bagi
