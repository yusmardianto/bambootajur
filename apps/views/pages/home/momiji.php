...
<div class="container">
  ...
  <section class="type__header">
    <div class="row align-items-center">
      <div class="col-md-3"><h2 class="head-title">TIPE MOMIJI</h2></div>
      <div class="col-md-3 col-xl-5"><hr></div>
      <div class="col-md-6 col-xl-4"><a href="<?php echo base_url ('the-homes/akane'); ?>" class="form-control btn">Lihat Juga Tipe Akane &nbsp; <span>&rarr;</span></a></div>
    </div>
  </section>
