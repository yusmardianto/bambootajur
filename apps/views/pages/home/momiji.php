    ...
    <div class="title-section-line">
      <div class="mr-md-4">
        <div class="jumbotron__category">
            <h1 class="head-title">Tipe Rumah Momiji</h1>
        </div>
      </div>
      <div>
        <hr>
...
<div class="container">
  ...
  <ul class="nav nav-tabs green-tabs" role="tablist">
    <li class="nav-item text-center">
      <a class="nav-link momiji-tab active" data-toggle="tab" role="tab" aria-controls="type-momiji" href="#type-momiji" aria-selected="true">Type Momiji</a>
    </li>
  </ul>
  <div class="tab-content type-home">
    <div id="type-momiji" class="tab-pane fade show active" role="tabpanel" aria-labelledby="momiji-tab">
      <div class="row">
