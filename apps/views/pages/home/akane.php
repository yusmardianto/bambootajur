...
<div class="container">
  ...
  <section class="type__header">
    <div class="row align-items-center">
      ...
      <div class="col-8 col-md-6 col-xl-4 order-2 order-md-3"><a href="<?php echo base_url ('the-homes/momiji'); ?>" class="form-control btn">Lihat Juga Tipe Momiji &nbsp; <span>&rarr;</span></a></div>
    </div>
  </section>
