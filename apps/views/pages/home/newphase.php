...
<section class="page-banner">
  ...
  <div class="banner-caption captionnewphase">
    <h1 class="m-0">
      <div class="d-flex caption1 justify-content-center">TELAH DIBUKA <div class="banner-line"></div>
      </div>
  ...
  <div class="container">
    <div class="main-content new-phase-content">
      ...
      <picture>
        ...
        <img srcset="<?php echo base_url(); ?>assets/images/new-phase/nu-phase.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/nu-phase.jpg" alt="" class=" alignleft" width="540" height="405" loading="lazy">
      </picture>
      ...
      <p>Dengan cara ini, pengembang bisa memanjakan calon pembeli potensial dengan memberikan berbagai penawaran menarik.</p>

      <p>Kalau kamu berkesempatan mendapatkan nomor urut pemesanan, kamu bisa memilih unit rumah terbaik, letak unit di lokasi strategis, dan ditambah pemotongan harga properti dari pengembang.</p>

      <p>Bagi pembeli, NUP sudah pasti bisa mendatangkan beragam keuntungan, seperti mendapatkan harga properti lebih murah dibandingkan harga normal. <br><br></p>
      <p>Tak hanya itu, pembeli juga bisa mendapatkan promo-promo menarik yang diberikan untuk pemilik NUP. Selain mendapatkan potongan harga, pembeli juga bisa memilih tipe unit dengan bebas, loh. Menarik bukan? Untuk mendapatkan Nomor NUP, pembeli cukup menyetorkan uang sejumlah 5 Juta Rupiah yang bersifat refundable</p>

    </div>
    <div class="main-content new-phase-content">
      <picture>
        <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/launching.webp" type="image/webp">
        <img srcset="<?php echo base_url(); ?>assets/images/new-phase/launching.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/launching.jpg" alt="" class=" alignleft" width="540" height="405" loading="lazy">
      </picture>
      ...
      <div class="row">
        <div class="col-sm-4">
          <picture>
            ...
            <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-facade-design.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-facade-design.jpg" alt="" class=" img-responsive" width="350" height="225" loading="lazy">
          </picture>
        ...
        <div class="col-sm-4">
          <picture>
            ...
            <img srcset="<?php echo base_url(); ?>assets/images/new-phase/genkan.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/genkan.jpg" alt="" class=" img-responsive" width="350" height="225" loading="lazy">
          </picture>
        ...
        <div class="col-sm-4">
          <picture>
            ...
            <img srcset="<?php echo base_url(); ?>assets/images/new-phase/location.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/location.jpg" alt="" class=" img-responsive" width="350" height="225" loading="lazy">
          </picture>
...
<section class="newpage-content newphase-galery">
  <div class="container">
    <!-- Nav tabs -->
    <ul class="nav nav-tabs galery-tabs">
      <li class="nav-item">
        <a class="nav-link active akanetab" data-toggle="tab" href="#home">NEW AKANE</a>
      </li>
      <li class="nav-item">
        <a class="nav-link momijitab" data-toggle="tab" href="#menu1">NEW MOMIJI</a>
      </li>

    </ul>

    <!-- Tab panes -->
    <div class="tab-content galery-tabs-content">
      <div class="tab-pane   active" id="home">
        <div class="tab-coontent-info d-flex justify-content-between pt-3 pb-3">
        ...
        <div class="galery-list akane-galery d-flex">
          <div class="galeri-tem">
            <picture>
              ...
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery1.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery1.jpg" alt="" class=" img-responsive" width="720" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
              <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/new-akane-galery2.webp" type="image/webp">
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery2.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery2.jpg" alt="" class=" img-responsive" width="360" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
              <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/new-akane-galery3.webp" type="image/webp">
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery3.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery3.jpg" alt="" class=" img-responsive" width="540" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
              <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/new-akane-galery4.webp" type="image/webp">
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery4.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery4.jpg" alt="" class=" img-responsive" width="540" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
              <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/new-akane-galery5.webp" type="image/webp">
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery5.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery5.jpg" alt="" class=" img-responsive" width="360" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
              <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/new-akane-galery6.webp" type="image/webp">
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery6.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-akane-galery6.jpg" alt="" class=" img-responsive" width="720" height="450" loading="lazy">
            </picture>
          </div>
        </div>
        ...
        <!-- The Modal -->
        <div class="modal modal-denah" id="denahAkane">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">

              <!-- Modal Header -->
              <div class="modal-header justifu-content-center">
                <h4 class="modal-title">DENAH NEW AKANE</h4>
              ...
              <div class="modal-body">
                <picture>
                  ...
                  <img srcset="<?php echo base_url(); ?>assets/images/new-phase/denah-akane.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/denah-akane.jpg" alt="" class=" img-responsive" width="766" height="777" loading="lazy">
                </picture>
      ...
      <div class="tab-pane   fade" id="menu1">
        ...
        <div class="galery-list momiji-galery d-flex">
          ...
          <div class="galeri-tem">
            <picture>
              ...
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery2.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery2.jpg" alt="" class=" img-responsive" width="360" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
              <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/new-momiji-galery3.webp" type="image/webp">
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery3.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery3.jpg" alt="" class=" img-responsive" width="540" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
              <source srcset="<?php echo base_url(); ?>assets/images/new-phase/webp/new-momiji-galery4.webp" type="image/webp">
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery4.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery4.jpg" alt="" class=" img-responsive" width="540" height="450" loading="lazy">
            </picture>
          </div>
          <div class="galeri-tem">
            <picture>
          ...
          <div class="galeri-tem">
            <picture>
              ...
              <img srcset="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery6.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/new-momiji-galery6.jpg" alt="" class=" img-responsive" width="720" height="450" loading="lazy">
            </picture>
          </div>
        </div>
        <div class="btn-container d-flex justify-content-center">
        ...
        <!-- The Modal -->
        <div class="modal modal-denah" id="denahMoiji">
          <div class="modal-dialog  modal-lg">
            <div class="modal-content">

              <!-- Modal Header -->
              <div class="modal-header  justify-content-center">
                <h4 class="modal-title text-center">DENAH NEW MOMIJI</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
              </div>
              ...
              <div class="modal-body">
                <picture>
                  ...
                  <img srcset="<?php echo base_url(); ?>assets/images/new-phase/denah-momiji.jpg" sizes="(max-width: 576px) 576px" src="<?php echo base_url(); ?>assets/images/new-phase/denah-momiji.jpg" alt="" class=" img-responsive" width="766" height="777" loading="lazy">
                </picture>
...
<script defer>
  $(window).scroll(function() {
    $(this).scrollTop() >= 50 ? $("#return-to-top").fadeIn(100) : $("#return-to-top").fadeOut(0)
