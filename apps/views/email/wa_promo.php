...
<!-- Body content -->
                                <tr>
                                    <td class='content-cell' style='font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;'>
                                        <h1 style='font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;'>Whatsapp Inquiry Promo Landing Page</h1>
                                        <p style='font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;'>
                                            <b>This is whatsapp inquiry promo landing page from  https://bambootajur.com/</b>
                                            <br><br>
                                            <b>Nama</b>
                                            <br><?= $data['name'] ?>
                                            <br><br>
